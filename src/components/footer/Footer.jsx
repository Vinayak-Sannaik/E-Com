      ...
      >
        <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
          ...
          >
            © 2023 E-Com —
            <a
              href="https://www.linkedin.com/in/Vinayak-Sannaik/"
          ...
          {/* <a href="https://www.linkedin.com/in/Vinayak-Sannaik/"></a> */}

          <span  className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            <a href="https://www.linkedin.com/in/Vinayak-Sannaik/" target="_blank" className="text-gray-500">
              <svg
                fill="currentColor"
                strokeLinecap="round"
            ...
            <a href="https://www.linkedin.com/in/Vinayak-Sannaik/" target="_blank" className="ml-3 text-gray-500">
              <svg
                fill="currentColor"
                strokeLinecap="round"
                strokeLinejoin="round"
